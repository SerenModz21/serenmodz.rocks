import { FaCode, FaGithub, FaSpotify, FaTwitter } from "react-icons/fa";
...
export default function Footer() {
  ...
  return (
    <footer className="footer hidden border-t border-base-300 bg-base-200 px-10 py-4 text-base-content md:grid">
      <div className="grid-flow-col items-center">
        {data?.songUrl ? (
          ...
          <>
            {/* temp image (credits to daisy ui examples) TODO: change image */}
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            <p>
              Seren_Modz 21
              <br />A self-taught backend programmer.
            </p>
          </>
        )}
      </div>
